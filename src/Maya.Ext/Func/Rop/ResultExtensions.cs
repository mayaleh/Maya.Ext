...
namespace Maya.Ext.Func.Rop
{
    ...
    {
        public static Unit Handle<TSuccess, TFailure>(this Result<TSuccess, TFailure> result,
        ...
        public static Unit MatchFailureAction<TSuccess, TFailure>(
            this Result<TSuccess, TFailure> x,
            Action<TFailure> onFailure)
        {
            if (x.IsFailure)
        ...
        public static Unit MatchSuccessAction<TSuccess, TFailure>(
            this Result<TSuccess, TFailure> x,
            Action<TSuccess> onSuccess)
        {
            if (x.IsFailure)
